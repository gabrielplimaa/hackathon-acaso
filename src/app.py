...
# ==========================================
# SYSTEM DESIGN & CUSTOM CSS (GLASSMORPHISM)
# ==========================================
st.markdown("""
<style>
    ...
    .stApp {
        background: radial-gradient(circle at 50% -20%, #1e1b4b 0%, #0f172a 45%, #080d1a 100%);
        color: #f8fafc;
    }
